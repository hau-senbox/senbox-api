...
func (r *ValuesAppCurrentRepository) GetAllByDeviceID(deviceID string) ([]*entity.ValuesAppCurrent, error) {
	var logs []*entity.ValuesAppCurrent
	if err := r.DBConn.Where("device_id = ?", deviceID).Find(&logs).Error; err != nil {
		return nil, err
	}
	return logs, nil
}
